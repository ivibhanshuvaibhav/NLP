...
# loading original bayes classifier from pickle file
...
print "Accuracy of our modified model is: ", nltk.classify.accuracy(voted_classifiers, testing_set) * 100
